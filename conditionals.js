...
if (item=="jacket"){
     money = money - 40;  health = health + 20; console.log("You bought a jacket");
}
else if (item=="candy"){
     money = money - 10; console.log("You bought candy");
}
else if (item=="paint"){
   money = paint -30; console.log("You bought paint");
}
else if (item=="hammer"){
    money = money - 70; console.log("You bought hammer");
}
else{
...
if (typeof choice == undefined){
   money = money - 100; console.log("You shut down due to inactivity and get robbed of all your money");
}
else if (typeof choice == undefined && randomPerson == "Felipe"){
    console.log("The protesters attack you...");
    if(item != "jacket"){
        console.log("...but Felipe, a fellow android shows up to help you escape them");
    }
    else{
        health = health - 50 ;console.log("...and Felipe, a fellow android, who would normally help doesn't recognize you with the jacket");
    }
else if (typeof choice == "run" && randomPerson == "John"){
    console.log("You run, but John, a human officer with an attitude and a heart of gold, finds you...");
    if(item == "hammer" || "jacket"){
        money = money - 100;console.log("...and holds you for questioning for suspicious activity");
    }
    else{
